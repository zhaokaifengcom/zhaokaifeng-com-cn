...
设函数 $f(x) = \arctan x$, 若 $f ( x ) = x f^{\prime}(\xi)$, 则 $\lim_{x \rightarrow 0} \frac{ \xi^{2}}{ x^{2}} =$ ()
...
$\begin{aligned} & \lim _ { n \rightarrow \infty } \ln \left[ \frac { n - 2 n a + 1 } { n ( 1 - 2 a ) } \right] ^ { n } \\
= & \ln \left\{ \lim _ { n \rightarrow \infty } \left[ 1 + \frac { 1 } { n ( 1 - 2 a ) } \right] ^ { n } \right\} \\
= & \ln \left\{ \lim _ { n \rightarrow \infty } \left[ 1 + \frac { 1 } { n ( 1 - 2 a ) } \right] ^ { n ( 1 - 2 a ) \cdot \frac { 1 } { 1 - 2 a } } \right\} \\
= & \ln \mathrm { e } ^ { \frac { 1 } { 1 - 2 a } } \\
= & \frac { 1 } { 1 - 2 a } \end{aligned}$
...
$\begin{aligned} & \lim _ { n \rightarrow \infty } \left[ \frac { 1 } { 1 \cdot 2 } + \frac { 1 } { 2 \cdot 3 } + \cdots + \frac { 1 } { n ( n + 1 ) } \right] ^ { n } \\ 
= & \lim _ { n \rightarrow \infty } \left[ 1 - \frac { 1 } { 2 } + \frac { 1 } { 2 } - \frac { 1 } { 3 } + \cdots + \frac { 1 } { n } - \frac { 1 } { n + 1 } \right] ^ { n } \\
= & \lim _ { n \rightarrow \infty } \left( 1 - \frac { 1 } { n + 1 } \right) ^ { n } \\
= & \lim _ { n \rightarrow \infty } \left( 1 - \frac { 1 } { n + 1 } \right) ^ { - ( n + 1 ) \cdot \frac { n } { n + 1 } } \\
= & \mathrm { e } ^ { - 1 } \end{aligned}$
...
- 极限
- [夹逼准则](https://zhaokaifeng.com/20951/)
...
于是，由[夹逼准则](https://zhaokaifeng.com/17265/)，可知 $\lim _ { n \rightarrow \infty } \left( \frac { 1 } { n ^ { 2 } + n + 1 } + \frac { 2 } { n ^ { 2 } + n + 2 } + \cdots + \frac { n } { n ^ { 2 } + n + n } \right) = \frac { 1 } { 2 }$
...
$\begin{aligned} & \sqrt { 1 + 2 + \cdots + n } - \sqrt { 1 + 2 + \cdots + ( n - 1 ) } \\
= & \sqrt { \frac { n ( n + 1 ) } { 2 } } - \sqrt { \frac { n ( n - 1 ) } { 2 } } \\
= & \sqrt { \frac { n } { 2 } } ( \sqrt { n + 1 } - \sqrt { n - 1 } ) \\
= &  \sqrt { \frac { n } { 2 } } \cdot \frac { 2 } { \sqrt { n + 1 } + \sqrt { n - 1 } } \\
= & \sqrt { 2 } \cdot \frac { \sqrt { n } } { \sqrt { n + 1 } + \sqrt { n - 1 } } \end{aligned}$

于是：

$\begin{aligned} & \lim _ { n \rightarrow \infty } [ \sqrt { 1 + 2 + \cdots + n } - \sqrt { 1 + 2 + \cdots + ( n - 1 ) } ] \\
= & \lim _ { n \rightarrow \infty } \sqrt { 2 } \cdot \frac { \sqrt { n } } { \sqrt { n + 1 } + \sqrt { n - 1 } } \\
= & \sqrt { 2 } \lim _ { n \rightarrow \infty } \frac { \sqrt { n } } { \sqrt { n } \left( \sqrt { 1 + \frac { 1 } { n } } + \sqrt { 1 - \frac { 1 } { n } } \right) } \\
= & \sqrt { 2 } \lim _ { n \rightarrow \infty } \frac { 1 } { \sqrt { 1 + \frac { 1 } { n } } + \sqrt { 1 - \frac { 1 } { n } } } \\
= & \frac { \sqrt { 2 } } { 2 }
 \end{aligned}$
...
$\begin{aligned} & \lim _ { n \rightarrow \infty } ( \sqrt { n + 3 \sqrt { n } } - \sqrt { n - \sqrt { n } } ) \\
= & \lim _ { n \rightarrow \infty } \frac { ( \sqrt { n + 3 \sqrt { n } } - \sqrt { n - \sqrt { n } } ) ( \sqrt { n + 3 \sqrt { n } } + \sqrt { n - \sqrt { n } } ) } { \sqrt { n + 3 \sqrt { n } } + \sqrt { n - \sqrt { n } } } \\
= & \lim _ { n \rightarrow \infty } \frac { 4 \sqrt { n } } { \sqrt { n } \left( \sqrt { 1 + \frac { 3 } { \sqrt { n } } } + \sqrt { 1 - \frac { 1 } { \sqrt { n } } } \right) } \\
= & \frac { 4 } { \lim _ { n \rightarrow \infty } \sqrt { 1 + \frac { 3 } { \sqrt { n } } } + \lim _ { n \rightarrow \infty } \sqrt { 1 - \frac { 1 } { \sqrt { n } } } } \\
= & 2 \end{aligned}$
...
$\begin{aligned} & \lim _ { n \rightarrow \infty } \left( \frac { n - 2 } { n + 1 } \right) ^ { n } \\
= & \lim _ { n \rightarrow \infty } \left( 1 + \frac { - 3 } { n + 1 } \right) ^ { \left( - \frac { n + 1 } { 3 } \right) \cdot \left( - \frac { 3 } { n + 1 } \right) \cdot n } \\
= & \lim _ { n \rightarrow \infty } \mathrm{e}^{ \frac{-3n}{n+1} } \\
= & \lim _ { n \rightarrow \infty } \mathrm{e}^{-3} \end{aligned}$
...
\begin{aligned}
& \lim_{x \to 0} (\cos 2x + 2x \sin x)^{\frac{1}{x^4}} \\ \\
= & \lim_{x \to 0} (1 + \cos 2x + 2x \sin x - 1)^{\frac{1}{\cos 2x + 2x \sin x - 1} \cdot \frac{\cos 2x + 2x \sin x - 1}{x^4}}
\end{aligned}
$$
...
$$
\lim_{x \to 0} (1 + \cos 2x + 2x \sin x - 1)^{\frac{1}{\cos 2x + 2x \sin x - 1}} = e
$$
...
$$
\begin{aligned}
& \lim_{x \to 0} \frac{\cos 2x + 2x \sin x - 1}{x^4} \\ \\
= & \lim_{x \to 0} \frac{1 - \frac{1}{2!}(2x)^2 + \frac{1}{4!}(2x)^4 + o(x^4) + 2x \left[ x - \frac{x^3}{6} + o(x^3) \right] - 1}{x^4} \\ \\
= & \lim_{x \to 0} \frac{\frac{1}{3}x^4 + o(x^4)}{x^4} = \frac{1}{3}
\end{aligned}
$$
...
$$
\lim_{x \to 0} (\cos 2x + 2x \sin x)^{\frac{1}{x^4}} = e^{\frac{1}{3}}
$$
...
\begin{aligned}
& \lim_{x \to 0} \left[ \frac{\ln(1 + x)}{x} \right]^{\frac{1}{e^x - 1}} \\ \\
= & \lim_{x \to 0} \left[ 1 + \frac{\ln(1 + x)}{x} - 1 \right]^{\frac{1}{\frac{\ln(1 + x)}{x} - 1} \cdot \frac{\frac{\ln(1 + x)}{x} - 1}{e^x - 1}}
\end{aligned}
$$
...
$$
\lim_{x \to 0} \left[ 1 + \frac{\ln(1 + x)}{x} - 1 \right]^{\frac{1}{\frac{\ln(1 + x)}{x} - 1}} = e
$$

且：

$$
\lim_{x \to 0} \frac{\frac{\ln(1 + x)}{x} - 1}{e^x - 1} = \lim_{x \to 0} \frac{\ln(1 + x) - x}{x^2} = \lim_{x \to 0} \frac{-\frac{1}{2}x^2}{x^2} = -\frac{1}{2}
$$

综上：

$$
\lim_{x \to 0} \left[ \frac{\ln(1 + x)}{x} \right]^{\frac{1}{e^x - 1}} = e^{-\frac{1}{2}}
$$
...
\begin{aligned}
& \lim_{x \to 0} \frac{e^{x^2} - e^{2-2\cos x}}{x^4} \\ \\
= & \lim_{x \to 0} e^{x^2} \cdot \frac{(1 - e^{-x^2 + 2 - 2\cos x})}{x^4} \\ \\
= & \lim_{x \to 0} \frac{1 - e^{-x^2 + 2 - 2\cos x}}{x^4} \\ \\
= & \lim_{x \to 0} \frac{-(-x^2 + 2 - 2\cos x)}{x^4} \\ \\
= & \lim_{x \to 0} \frac{x^2 + 2\cos x - 2}{x^4} \\ \\
= & \lim_{x \to 0} \frac{x^2 + 2 \left[ 1 - \frac{1}{2!}x^2 + \frac{1}{4!}x^4 + o(x^4) \right] - 2}{x^4} \\ \\
= & 2 \cdot \frac{1}{4!} = \frac{1}{12}
\end{aligned}
$$
...
\begin{aligned}
& \lim_{x \to 0} \frac{\sqrt{1 + 2\sin x} - x - 1}{x \ln(1 + x)} \\ \\
= & \lim_{x \to 0} \frac{(1 + 2\sin x) - (x + 1)^2}{x^2 [\sqrt{1 + 2\sin x} + (x + 1)]} \\ \\
= & \frac{1}{2} \lim_{x \to 0} \frac{2\sin x - x^2 - 2x}{x^2} \\ \\
= & \frac{1}{2} \left[ \lim_{x \to 0} \frac{2(\sin x - x)}{x^2} - \lim_{x \to 0} \frac{x^2}{x^2} \right] \\ \\
= & \frac{1}{2} \left( -2 \cdot \frac{1}{6} x^3 \lim_{x \to 0} \frac{1}{x^2} - 1 \right) \\ \\
= & -\frac{1}{2}
\end{aligned}
$$
...
\begin{aligned}
& \lim_{x\to +\infty}(x+e^x)^{\frac{1}{x}} \\ \\
= & \lim_{x\to +\infty}e^{\frac{\ln(x+e^x)}{x}}=e^{\lim_{x\to +\infty}\frac{\ln(x+e^x)}{x}} \\ \\
= & e^{\lim_{x\to +\infty}\frac{1+e^x}{x+e^x}}=e^{\lim_{x\to +\infty}\frac{e^x(1+e^{-x})}{e^x(\frac{x}{e^x}+1)}}=e^1=e
\end{aligned}
$$
...
$\lim_{x\to0}\frac{(1-\cos x)[x-\ln(1+\tan x)]}{\sin^4 x} = ?$
...
\begin{aligned}
& \lim_{x\to0}\frac{(1-\cos x)[x-\ln(1+\tan x)]}{\sin^4 x} \\ \\
= & \lim_{x\to0}\frac{\frac{1}{2}x^2[x-\ln(1+\tan x)]}{x^4} \\ \\
= & \frac{1}{2}\lim_{x\to0}\frac{x-\ln(1+\tan x)}{x^2} \\ \\
= & \frac{1}{2}\left(\lim_{x\to0}\frac{x-\tan x}{x^2}+\lim_{x\to0}\frac{\tan x-\ln(1+\tan x)}{x^2}\right) \\ \\
= & \frac{1}{2}\left\{\lim_{x\to0}\frac{-\frac{1}{3}x^3}{x^2}+\lim_{x\to0}\frac{\frac{1}{2}\tan^2 x}{x^2}\right\} \\ \\
= & \frac{1}{2}\times\left(0+\frac{1}{2}\right)=\frac{1}{4}
\end{aligned}
$$

:::tip
同类题目的深度解析，[请点击这里](https://zhaokaifeng.com/)
:::
...
\begin{aligned}
& \lim_{x\to0}\frac{[\sin x-\sin(\sin x)]\sin x}{x^4} \\ \\
= & \lim_{x\to0}\frac{[\sin x-\sin(\sin x)]\sin x}{\sin^4 x} \\ \\
= & \lim_{x\to0}\frac{\sin x-\sin(\sin x)}{\sin^3 x}
\end{aligned}
$$
...
\begin{aligned}
& \lim_{x\to0}\frac{\sin x-\sin(\sin x)}{\sin^3 x} \\ \\
= & \lim_{x\to0}\frac{t-\sin t}{t^3}=\lim_{x\to0}\frac{\frac{1}{6}t^3}{t^3}=\frac{1}{6}
\end{aligned}
$$
...
$\lim_{x\to0}\left(\frac{1+x}{1-e^{-x}}-\frac{1}{x}\right) = ?$
...
\begin{aligned}
& \lim_{x\to0}\left(\frac{1+x}{1-e^{-x}}-\frac{1}{x}\right) \\ \\
= & \lim_{x\to0}\frac{x(1+x)-(1-e^{-x})}{x(1-e^{-x})} \\ \\
= & \lim_{x\to0}\frac{x+x^2-1+e^{-x}}{x^2} \\ \\
= & \lim_{x\to0}\frac{1+2x-e^{-x}}{2x} \\ \\
= & 1+\lim_{x\to0}\frac{1-e^{-x}}{2x} \\ \\
= & 1+\lim_{x\to0}\frac{x}{2x}=\frac{3}{2}
\end{aligned}
$$
...
\begin{aligned}
& \lim_{x \to 0} \frac{1}{x^3} \left[ \left( \frac{2 + \cos x}{3} \right)^x - 1 \right] \\ \\
= \ & \lim_{x \to 0} \frac{\mathrm{e}^{x \ln \frac{2 + \cos x}{3}} - 1}{x^3} \\ \\
= \ & \lim_{x \to 0} \frac{x \ln \frac{2 + \cos x}{3}}{x^3} = \lim_{x \to 0} \frac{\ln \left( 1 + \frac{2 + \cos x}{3} - 1 \right)}{x^2} \\ \\
= \ & \lim_{x \to 0} \frac{\frac{2 + \cos x}{3} - 1}{x^2} = \lim_{x \to 0} \frac{\cos x - 1}{3 x^2} \\ \\
= \ & \lim_{x \to 0} \frac{-\frac{1}{2} x^2}{3 x^2} = -\frac{1}{6}
\end{aligned}
$$
...
$$
\begin{aligned}
& \lim_{x\to0}\left(\frac{1}{\sin^{2}x}-\frac{\cos^{2}x}{x^{2}}\right) = \lim_{x\to0}\frac{x^{2}-\sin^{2}x\cos^{2}x}{x^{2}\sin^{2}x} \\ \\
= \ & \lim_{x\to0}\frac{x^{2}-\left(\frac{1}{2}\sin2x\right)^{2}}{x^{4}}
= \lim_{x\to0}\frac{\left(x+\frac{1}{2}\sin2x\right)\left(x-\frac{1}{2}\sin2x\right)}{x^{4}} \\ \\
= \ & \lim_{x\to0}\frac{\left(x+\frac{1}{2}\sin2x\right)(2x-\sin2x)}{2x^{4}}
= \lim_{x\to0}\frac{\frac{1}{6}(2x)^{3}\left(x+\frac{1}{2}\sin2x\right)}{2x^{4}} \\ \\
= \ & \frac{2}{3}\lim_{x\to0}\frac{x+\frac{1}{2}\sin2x}{x} = \frac{2}{3}\left(\lim_{x\to0}\frac{x}{x}+\frac{1}{2}\lim_{x\to0}\frac{\sin2x}{x}\right) \\ \\
...
对于含有 $e^{\frac{1}{x}}$ 且 $x \rightarrow 0$ 的极限式子，我们需要对 $x \rightarrow 0^{-}$ 和 $x \rightarrow 0^{+}$ 分别讨论：

$x \rightarrow 0^{-}$:

$$
\begin{aligned}
& \lim_{x \to 0^-} \left( \frac{2 + e^{\frac{1}{x}}}{1 + e^{\frac{4}{x}}} + \frac{\sin x}{|x|} \right) = \lim_{x \to 0^-} \frac{2 + e^{\frac{1}{x}}}{1 + e^{\frac{4}{x}}} + \lim_{x \to 0^-} \frac{\sin x}{x} \\ \\
= & \lim_{x \to 0^-} \frac{e^{\frac{1}{x}} \left( \frac{2}{e^{\frac{1}{x}}} + 1 \right)}{e^{\frac{4}{x}} \left( \frac{1}{e^{\frac{4}{x}}} + 1 \right)} + 1 = \lim_{x \to 0^-} \frac{1}{e^{\frac{3}{x}}} + 1 = 1
\end{aligned}
$$
...
综上可知：$\lim_{x \to 0} \left( \frac{2 + e^{\frac{1}{x}}}{1 + e^{\frac{4}{x}}} + \frac{\sin x}{|x|} \right) = 1$.
...
\begin{aligned}
& \lim_{x \to 0} \frac{\sqrt{1 + \tan x} - \sqrt{1 + \sin x}}{x \ln(1 + x) - x^2} \\ \\
= & \lim_{x \to 0} \frac{(\sqrt{1 + \tan x} - \sqrt{1 + \sin x})(\sqrt{1 + \tan x} + \sqrt{1 + \sin x})}{x [\ln(1 + x) - x] (\sqrt{1 + \tan x} + \sqrt{1 + \sin x})} \\ \\
= & \lim_{x \to 0} \frac{\tan x - \sin x}{x \cdot \left(-\frac{1}{2} x^2\right) \cdot 2} \\ \\
