...
已知函数 $f ( x )$ 连续，且 $\lim _ { x \rightarrow 0 } \frac { 1 - \cos [ x f ( x ) ] } { \left( \mathrm { e } ^ { x ^ { 2 } } - 1 \right) f ( x ) } = 1 ,$ $f ( 0 ) = ?$
...
$$
\begin{aligned}
1 = & \lim _ { x \rightarrow 0 } \frac { 1 - \cos [ x f ( x ) ] } { \left( \mathrm { e } ^ { x ^ { 2 } } - 1 \right) f ( x ) } \\ \\
= & \lim _ { x \rightarrow 0 } \frac { \frac { 1 } { 2 } x ^ { 2 } f ^ { 2 } ( x ) } { x ^ { 2 } f ( x ) } \\ \\
= & \frac { 1 } { 2 } \lim _ { x \rightarrow 0 } f ( x ) \\ \\
\to & \lim _ { x \rightarrow 0 } f ( x ) = 2
\end{aligned}
$$
...
设函数 $f ( x ) = \left\{ \begin{array} { l l } x ^ { 2 } + 1 , & | x | \leqslant c , \\ \frac { 2 } { | x | } , & | x | > c \end{array} \right.$ 在 $( - \infty , + \infty )$ 内连续，则 $c = ?$
...
由于 $f ( x )$ 在 $( - \infty , + \infty )$ 内连续，所以 $f ( x )$ 在 $x = c$ 处连续，即：
...
$$
\begin{aligned}
& \lim _ { x \rightarrow c^+ } \frac { 2 } { x } = \lim _ { x \rightarrow c^-} \left( x ^ { 2 } + 1 \right) \\ \\
\to & \frac { 2 } { c } = c ^ { 2 } + 1
\end{aligned}
$$
...
$$
f ( x ) = \lim _ { n \rightarrow \infty } \frac { ( n - 1 ) x } { n x ^ { 2 } + 1 } = \left\{ \begin{array} { l l } \frac { 1 } { x } , & x \neq 0 , \\ 0 , & x = 0 . \end{array} \right.
$$

又因为 $\lim _ { x \rightarrow 0 } f ( x ) = \lim _ { x \rightarrow 0 } \frac { 1 } { x } = \infty$, 所以 $x = 0$ 为 $f ( x )$ 的无穷间断点.
...
设函数 $f ( x ) = \left\{ \begin{array} { l l } \frac { 1 - \mathrm { e } ^ { \tan x } } { \arcsin \frac { x } { 2 } } , & x > 0 , \\ a \mathrm { e } ^ { 2 x } , & x \leqslant 0 \end{array} \right.$ 在 $x = 0$ 处连续，则 $a = ?$
...
= & \lim _ { x \rightarrow 0^+ } \frac { 1 - \mathrm { e } ^ { \tan x } } { \arcsin \frac { x } { 2 } } = \lim _ { x \rightarrow 0^+ } \frac { - \tan x } { \frac { x } { 2 } } \\ \\
= & \lim _ { x \rightarrow 0^+ } \frac { - x } { \frac { x } { 2 } } = - 2
\end{aligned}
$$
...
$$
\begin{aligned}
a = & f ( 0 ) = \lim _ { x \rightarrow 0 } f ( x ) = \lim _ { x \rightarrow 0 } ( \cos x ) ^ { x^{-2} } \\ \\
= & \mathrm { e } ^ { \lim _ { x \rightarrow 0 } x ^ { -2 } \ln \cos x } = \mathrm { e } ^ { \lim _ { x \rightarrow 0 } x ^ { -2 } ( \cos x - 1 ) } \\ \\
= & \mathrm { e } ^ { \lim _ { x \rightarrow 0 } - \frac { 1 } { 2 } x ^ { 2 } \cdot x ^ { - 2 } } = \mathrm { e } ^ { - \frac { 1 } { 2 } } \end{aligned}
$$
...
若 $f(x) = \begin{cases} \frac{\sin 2x + e^{2ax} - 1}{x}, & x \neq 0, \\ a, & x = 0 \end{cases} \text{ 在 } (-\infty, +\infty) \text{ 上连续，则 } a = \underline{\hspace{0.5cm}}.$
...
$$
\begin{aligned}
a = & \lim_{x \to 0} f(x)=\lim_{x \to 0} \frac{\sin 2x + e^{2ax} - 1}{x} \\ \\
= &  \lim_{x \to 0} \frac{\sin 2x}{x} + \lim_{x \to 0} \frac{e^{2ax} - 1}{x} \\ \\
= & 2 + \lim_{x \to 0} \frac{2ax}{x} \\ \\
= & 2 + 2a = a \\ \\
\to & a = -2
\end{aligned}
$$
...
设函数 $f(x)$ 有连续的导数, $f(0)=0$, $f'(0)=b$, 若函数 $F(x)=\begin{cases} \frac{f(x)+a\sin x}{x}, & x \neq 0, \\ A, & x=0 \end{cases} \text{ 在 } x=0$ 处连续, 则常数 $A = ?$
...
\begin{aligned}
& F(0)=\lim_{x \to 0}F(x) \\ \\
\to & A = \lim_{x \to 0}\frac{f(x)+a\sin x}{x}=\lim_{x \to 0}\frac{f(x)}{x}+\lim_{x \to 0}\frac{a\sin x}{x} \\ \\
\to & A = \lim_{x \to 0}\frac{f(x)-f(0)}{x}+a=f^{\prime}(0)+a=a + b
\end{aligned}
$$
...
设 $f(x) = \begin{cases} a + bx^2, & x \leq 0, \\ \frac{\sin bx}{x}, & x > 0 \end{cases}$ 在 $x = 0$ 处连续，则常数 $a$ 与 $b$ 应满足的关系是 $\_\_\_\_\_.$
...
由 $f(x)$ 在 $x = 0$ 处连续，故 $\lim_{x \to 0} f(x) = f(0)$，即 $\lim_{x \to 0} \frac{\sin bx}{x} = a$，得 $a = b$.
...
设 $f(x) = \begin{cases} 2x + a, & x \leq 0, \\ e^x (\sin x + \cos x), & x > 0 \end{cases}$ 在 $(-\infty, +\infty)$ 内连续，则 $a =$
...
因 $f(x)$ 在 $(-\infty, +\infty)$ 内连续，所以 $\lim_{x \to 0^+} f(x) = f(0)$，即：

$$
\begin{aligned}
& \lim_{x \to 0^+} e^x (\sin x + \cos x) = a \\ \\
\to & a = 1
\end{aligned}
$$
...
已知 $f(x)=e^{x^2}$, $f[\varphi(x)]=1-x$, 且 $\varphi(x)\geqslant0$, 求 $\varphi(x)$ 并写出它的定义域.
...
因为 $f(x)=e^{x^2}$, 故 $f[\varphi(x)]=e^{\varphi(x)^2}$. 又因为：
...
& e^{\varphi(x)^2}=1-x \\ \\
\to & \varphi^2(x)=\ln(1-x) \\ \\
\to & \varphi(x)=\sqrt{\ln(1-x)}, \varphi(x) \geqslant 0
\end{aligned}
$$

接着，由 $1-x>0$ 且 $\ln(1-x)\geqslant0$ 可知, $x<1$ 且 $1-x\geqslant1$, 即 $x\leqslant0$.

因此，$\varphi(x)$ 的定义域为 $(-\infty, 0]$.
